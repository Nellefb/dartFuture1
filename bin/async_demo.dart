...
//criar proj dart dart create (nome)
//.then é quando concluido com sucesso
...
Future<String> login(String email, String senha) async {
  ...
  //retorna o token se o email e senha corretos
...
//recebe o token se login for valido, retorna num
